...
//         : http://localhost:5001${profileData.profilePic}
...
//           lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
...
//                 <SidebarItem icon={Calendar} label="Dashboard" onClick={() => navigate('/admin/dashboard')} />
//                 <SidebarItem icon={Users} label="My Profile" active={true} onClick={() => navigate('/admin/myprofile')} />

//                 <div className="pt-6">
//                   <h5 className="text-sm font-medium text-gray-500 mb-2">Manage</h5>
//                   <div className="space-y-1">
//                     <SidebarItem icon={Users} label="Employee" onClick={() => navigate('/admin/manageemployee')} />
//                     <SidebarItem icon={Users} label="Jobseeker" onClick={() => navigate('/admin/managejobseeker')} />
//                     <SidebarItem icon={Users} label="Counselor" onClick={() => navigate('/admin/managecounselor')} />
//                     <SidebarItem icon={Users} label="Counselee" onClick={() => navigate('/admin/managecounselee')} />
//                   </div>
//                 </div>

//                 <div className="pt-6">
//                   <SidebarItem icon={MessageSquare} label="Messages" onClick={() => navigate('/message/login')} />
//                   <SidebarItem icon={PlusCircle} label="Add User" onClick={() => navigate('/admin/adduser')} />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                         <img src={getProfilePicUrl()} alt="Profile" className="w-full h-full object-cover" />
//                       </div>
...
//                     <ProfileField label="Admin Name" field="username" value={profileData.username} />
//                     <ProfileField label="Email ID" field="email" value={profileData.email} type="email" />
//                     <ProfileField label="Phone No." field="phone" value={profileData.phone} type="tel" />
//                     <ProfileField label="Address" field="address" value={profileData.address} />
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                 onClick={() => alert('Individual fields are saved automatically when you click Save on each field.')}
//               >
//                 Save Changes
//               </button>
//             </div>
